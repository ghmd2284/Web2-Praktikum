...
<!-- Mirrored from preview.colorlib.com/theme/essence/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 May 2023 11:31:45 GMT -->
...
<head>
    ...
    <script nonce="ceca5029-c619-410f-aa7b-ce5066c2c077">
        (function(w, d) {
        ...
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="user-login-info">
                    <a href="{{url('dashboard')}}"><img src="{{ asset('front/img/core-img/user.svg') }}" alt=""></a>
                </div>
